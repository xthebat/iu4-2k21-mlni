...
class MazeTest(unittest.TestCase):
    ...
    def test_adjacency_matrix(self):
        ...
        self.assertEqual(expected, maze.adjacency.to_dict())

        # better use this method but frozendict not suitable for it
        # self.assertDictEqual(expected, maze.adjacency.to_dict())
